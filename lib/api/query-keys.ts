export const queryKeys = {
  ...
  accountingPeriods: {
    root: ['accountingPeriods'] as const,
    list: (params?: Record<string, unknown>) =>
  ...
  articleMappingLines: {
    root: ['articleMappingLines'] as const,
    list: (params?: Record<string, unknown>) =>
      params
        ? (['articleMappingLines', 'list', params] as const)
        : (['articleMappingLines', 'list'] as const),
