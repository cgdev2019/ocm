...
- 2025-11-22 : `npm run test -- --runTestsByPath features/subscriptions/__tests__/useSubscriptions.test.tsx` → ok (relecture rapide du module Subscription, revalidé après correctif navigation détail/édition).
