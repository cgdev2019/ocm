# TASK063 — Service Contact

## Contexte
Le service « Contact » est défini par le tag OpenAPI du même nom dans `opencell.json` et doit être implémenté dans l'interface Next.js.
...
| --- | --- | --- | --- |
| GET | `/api/rest/contact` |  Find a contact with a given code  |     GET_Contact_search |
| POST | `/api/rest/contact` |  Create a new CRM Contact   | POST_Contact_create |
| PUT | `/api/rest/contact` |  Update a contact CRM informatopn  |     PUT_Contact_update |
| DELETE | `/api/rest/contact/{code}` |  Delete a contact with a given code  |     DELETE_Contact_{code} |
| PUT | `/api/rest/contact/{code}/{tag}` |  Add a tag to a contact with his code  |     PUT_Contact_{code}_{tag} |
| DELETE | `/api/rest/contact/{code}/{tag}` |  Delete a tag to a contact with his code  |     DELETE_Contact_{code}_{tag} |
| POST | `/api/rest/contact/createOrUpdate` |  Create or update a CRM contact   |     POST_Contact_createOrUpdate |
| POST | `/api/rest/contact/importCSVFile` |  Import the contact list from a file  |     POST_Contact_importCSVFile |
| POST | `/api/rest/contact/importCSVText` |  Import the contact list to a CSV file text  |     POST_Contact_importCSVText |
| GET | `/api/rest/contact/list` |  List contacts matching a given criteria  |     GET_Contact_list |
| POST | `/api/rest/contact/list` |  Retrieve a list by using paging and filter option  |     POST_Contact_list |
| GET | `/api/rest/contact/listGetAll` |  List Contacts matching a given criteria  |     GET_Contact_listGetAll |
| GET | `/api/rest/contact/version` | Get version of application | index_108 |

#### GET /api/rest/contact

- Résumé:  Find a contact with a given code 
...
- Réponses:
  - default: Request processing status
    - application/json: GetContactResponseDto
    - application/xml: GetContactResponseDto

#### POST /api/rest/contact

- Résumé:  Create a new CRM Contact  
- OperationId: POST_Contact_create
- Description: Create a new CRM Contact
- Sécurité: Aucune exigence déclarée
- Corps de requête:
  - optionnel
  - application/json: ContactDto
  - application/xml: ContactDto
- Réponses:
  - default: Request processing status
    - application/json: ActionStatus
    - application/xml: ActionStatus

#### PUT /api/rest/contact

- Résumé:  Update a contact CRM informatopn 
...
#### DELETE /api/rest/contact/{code}

- Résumé:  Delete a contact with a given code 
...
#### PUT /api/rest/contact/{code}/{tag}

- Résumé:  Add a tag to a contact with his code 
- OperationId:     PUT_Contact_{code}_{tag}
- Description: Add a tag to a contact with his code
- Sécurité: Aucune exigence déclarée
- Paramètres:
- `code` (PATH, obligatoire) — string
- `tag` (PATH, obligatoire) — string
- Réponses:
  - default: Request processing status
    - application/json: ActionStatus
    - application/xml: ActionStatus

#### DELETE /api/rest/contact/{code}/{tag}

- Résumé:  Delete a tag to a contact with his code 
...
#### POST /api/rest/contact/createOrUpdate

- Résumé:  Create or update a CRM contact  
...
#### POST /api/rest/contact/importCSVFile

- Résumé:  Import the contact list from a file 
...
#### POST /api/rest/contact/importCSVText

- Résumé:  Import the contact list to a CSV file text 
...
- Réponses:
  - default: Request processing status
    - application/json: ContactsResponseDto
    - application/xml: ContactsResponseDto

#### GET /api/rest/contact/list

- Résumé:  List contacts matching a given criteria 
...
#### POST /api/rest/contact/list

- Résumé:  Retrieve a list by using paging and filter option 
...
#### GET /api/rest/contact/listGetAll
