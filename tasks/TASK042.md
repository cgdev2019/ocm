# TASK042 — Service BusinessOfferModel

## Contexte
Le service « BusinessOfferModel » est défini par le tag OpenAPI du même nom dans `opencell.json` et doit être implémenté dans l'interface Next.js.
...
## Notes
- Description OpenAPI : @%BusinessOfferModel
...
| --- | --- | --- | --- |
| GET | `/api/rest/catalog/businessOfferModel` |  Remove an existing business offer model with a given code.   |     GET_BusinessOfferModel_search |
| POST | `/api/rest/catalog/businessOfferModel` |  Create a new business offer model.   |     POST_BusinessOfferModel_create |
| PUT | `/api/rest/catalog/businessOfferModel` |  Update an existing business offer model.   |     PUT_BusinessOfferModel_update |
| DELETE | `/api/rest/catalog/businessOfferModel/{businessOfferModelCode}` |  Remove an existing business offer model with a given code.   |     DELETE_BusinessOfferModel_{businessOfferModelCode} |
| POST | `/api/rest/catalog/businessOfferModel/createOrUpdate` |  Create new or update an existing business offer model.   |     POST_BusinessOfferModel_createOrUpdate |
| PUT | `/api/rest/catalog/businessOfferModel/install` |  Install business offer model module.  |     PUT_BusinessOfferModel_install |
| GET | `/api/rest/catalog/businessOfferModel/list` |  List business offer models.  |     GET_BusinessOfferModel_list |
| POST | `/api/rest/catalog/businessOfferModel/list` |  List business offer models.   |     POST_BusinessOfferModel_list |
| GET | `/api/rest/catalog/businessOfferModel/version` | Get version of application | index_46 |

#### GET /api/rest/catalog/businessOfferModel

- Résumé:  Remove an existing business offer model with a given code.  
- OperationId:     GET_BusinessOfferModel_search
- Description: Remove an existing business offer model with a given code.
- Sécurité: Aucune exigence déclarée
- Paramètres:
- `businessOfferModelCode` (QUERY, optionnel) — string
...
- `loadProductChargeTemplate` (QUERY, optionnel) — boolean
  - Contraintes: défaut: false
- Réponses:
  - default: A business offer model
    - application/json: GetBusinessOfferModelResponseDto
    - application/xml: GetBusinessOfferModelResponseDto

#### POST /api/rest/catalog/businessOfferModel

- Résumé:  Create a new business offer model.  
- OperationId:     POST_BusinessOfferModel_create
- Description: Create a new business offer model.
- Sécurité: Aucune exigence déclarée
- Corps de requête:
  - optionnel
  - application/json: BusinessOfferModelDto
  - application/xml: BusinessOfferModelDto
- Réponses:
  - default: Request processing status
    - application/json: ActionStatus
    - application/xml: ActionStatus

#### PUT /api/rest/catalog/businessOfferModel

- Résumé:  Update an existing business offer model.  
...
#### DELETE /api/rest/catalog/businessOfferModel/{businessOfferModelCode}
...
- Sécurité: Aucune exigence déclarée
- Paramètres:
- `businessOfferModelCode` (PATH, obligatoire) — string
- Réponses:
  - default: Request processing status
    - application/json: ActionStatus
    - application/xml: ActionStatus

#### POST /api/rest/catalog/businessOfferModel/createOrUpdate

- Résumé:  Create new or update an existing business offer model.  
...
#### PUT /api/rest/catalog/businessOfferModel/install
...
#### GET /api/rest/catalog/businessOfferModel/list

- Résumé:  List business offer models. 
...
- Réponses:
  - default: A list of business offer models
    - application/json: MeveoModuleDtosResponse
    - application/xml: MeveoModuleDtosResponse

#### POST /api/rest/catalog/businessOfferModel/list
...
#### GET /api/rest/catalog/businessOfferModel/version
...
Type: object
Champs obligatoires: code, offerTemplate
Propriétés:
- **id**: integer (int64)
